...
SCENARIO_CARDS: dict[str, dict[str, str]] = {
    ...
    "s10-silent-200": {
        ...
        "expect": "EXPECTED FAIL · status still Done",
        "delta": "fault",
    },
}
